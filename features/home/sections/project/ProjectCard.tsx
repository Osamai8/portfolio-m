...
import { PortfolioProject } from "@/assets/project/type";
    ...
    return (
        ...
        >
            ...
            <div className="p-3.5">
                ...
                <p className="mt-1.75 text-[13px] leading-[1.35] text-[#6b6b67]">
                    {project.subtitle}
                </p>
            </div>
        </Link>
...
const LedgerProjectCard = () => {
    return <Link href={`/work/${featuredProject.id}`}>
        <div className="grid min-h-55 grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] overflow-hidden rounded-[10px] border border-white/6 bg-[#191919] max-[620px]:grid-cols-1">
            ...
            >
                ...
                >
                    <span className="font-mono text-[28px] leading-none tracking-[-0.08em] text-[#c9713f]">
                        WL
                    </span>
            ...
            <div className="flex flex-col items-start justify-center px-7 py-6.5 max-[620px]:px-4.5 max-[620px]:py-5.5">
                <p className="mb-2.25 font-mono text-[11.5px] leading-[1.3] text-[#c9713f]">
                ...
                <div className="flex flex-wrap gap-1.75">
                    {featuredProject.tags.map((tag) => (
                        <span
                            key={tag}
                            className="rounded-full border border-white/14 px-1.75 py-1 font-mono text-[10.5px] leading-tight text-[#b8b8b3]"
                        >
                            {tag}
                        </span>
                    ))}
